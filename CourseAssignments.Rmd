...
```{r include=FALSE}
library(readr)
electric_vehicles <- read_csv("data/Electric_Vehicle_Population_Data.csv")
population_data <- read_csv("data/world_population_data.csv")
...
Follow-up Analysis: To identify specific pairs of vehicle makes with significant differences in electric ranges, post-hoc tests such as Tukey’s HSD are necessary.
